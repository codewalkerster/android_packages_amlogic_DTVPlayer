...
*/
	...
	private class DeviceItemAdapter extends BaseAdapter {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        if (convertView == null) {  // if it's not recycled, initialize some attributes
				if(heightPixels<480)
				{
		            convertView = mInflater.inflate(R.layout.device_grid_item_small, null);
				}
				...
				{
		            convertView = mInflater.inflate(R.layout.device_grid_item, null);
				}
				else
				{
		            convertView = mInflater.inflate(R.layout.device_grid_item_large, null);
				}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		{			
			//showDialog(DIALOG_INSERT_USB_MESSAGE);      	
        		showDia(DIALOG_INSERT_USB_MESSAGE);
		}
        
        GridView gridview = (GridView) findViewById(R.id.device_gridview);
        mDeviceItemAdapter = new DeviceItemAdapter(DeviceBrowser.this);
        ...
        returnButton.setOnClickListener(new returnSearchListener());
		returnButton.setOnFocusChangeListener(new ExitOnFocusChange());
		*/
