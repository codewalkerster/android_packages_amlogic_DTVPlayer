 ...
 * 
 */
public class TextViewWithCheck extends TextView implements Checkable {
	...
	public TextViewWithCheck(Context context) {
		this(context, null);
	}

	public TextViewWithCheck(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TextViewWithCheck(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		Drawable d = context.getResources().getDrawable(R.drawable.shortcut_bg_check);
		if (d != null) {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (checkMarkDrawable != null) {
			...
			int right = getWidth();
			checkMarkDrawable.setBounds(0, y, right, y
					+ height);
